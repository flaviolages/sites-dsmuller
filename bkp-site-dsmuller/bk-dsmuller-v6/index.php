...
<div class="service" data-height="height">
<div class="service-info">
<h3 class="mg3">RASTREAMENTO</h3>
<i class="service-icon mi3"><img src="img/rastreamento.png"></i>
</div>
<a href="rastreamento.html" class="content-wrapper-link"></a>
</div>
</div>
</div>
                ...
                <div class="row row-space-1 margin-b-2">
                        ...
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i1.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Transporte</h3>
                    ...
                    <div class="col-sm-4 sm-margin-b-2">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i2.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Abrangência</h3>
...
produtos e serviços no local onde são necessários, no momento em que são desejados.</p>
                    ...
                    <div class="col-sm-4">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i3.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Tecnologia</h3>
                ...
                <div class="row row-space-1">
                    <div class="col-sm-4 sm-margin-b-2">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".4s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i4.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Flexibilidade</h3>
                    ...
                    <div class="col-sm-4 sm-margin-b-2">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i5.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Armazenamento</h3>
                    ...
                    <div class="col-sm-4">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".6s">
                            <div class="service" data-height="height">
                                <div class="service-element">
                                    <i class="service-icon"><img src="img/i6.png"></i>
                                </div>
                                <div class="service-info">
                                    <h3>Logística</h3>
                ...
                <div class="swiper-slider swiper-clients">
                    ...
                    <div class="swiper-wrapper">
                      ...
                      -->
                        ...
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="img/clients/05.jpg" alt="Clients Logo">
                        </div>
